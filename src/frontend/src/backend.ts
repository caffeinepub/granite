...
export class Backend implements backendInterface {
    ...
    async deleteDrawing(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllDrawings(arg0: Principal): Promise<Array<DrawingMetadata>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllDrawings(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMyDrawings(): Promise<Array<DrawingMetadata>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMyDrawings();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTotalDrawings(arg0: Principal): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalDrawings(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTotalMinutesSpent(arg0: Principal): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalMinutesSpent(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveDrawing(arg0: DrawingMetadata): Promise<void> {
        if (this.processError) {
            try {
